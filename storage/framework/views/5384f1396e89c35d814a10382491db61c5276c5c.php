...
<head>
    ...
    <!-- Template Stylesheet -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/admin.css')); ?>">
</head>
                ...
                <div class="sidebar pe-4 pb-3">
                    <nav class="navbar bg-light navbar-light">
                        ...
                        <div class="d-flex align-items-center ms-4 mb-4">
                            ...
                            <div class="ms-3">
                                <h6 class="mb-0"><?php echo e($passenger->name); ?></h6>
                                <span>Admin</span>
                            </div>
                        </div>
                        <div class="navbar-nav w-100">
                            ...
                            <a href="<?php echo e(asset('profiles')); ?>" class="nav-item nav-link">
                                <i class="fa fa-solid fa-user"></i>
                                All Passengers</a>
                            <div class="nav-item dropdown">
                                <a href="<?php echo e(route('show.flight')); ?>" class="nav-link dropdown-toggle"
                                    data-bs-toggle="dropdown"><i
                                        class="fa fa-solid fa-plane fa-flip-vertical"></i>Flights</a>
                                <div class="dropdown-menu bg-transparent border-0">
                                    <a href="<?php echo e(route('show.flight')); ?>" class="dropdown-item"><i
                                            class="fa fa-solid fa-plane fa-flip-vertical"></i> All Flights</a>
                                    <a href="<?php echo e(route('admin.add')); ?>" class="dropdown-item"><i
                ...
                <div class="content">
                    ...
                    <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                        ...
                        <form class="d-none d-md-flex gap-2 ms-4">
                            <div class="card">
                                <div class="card-body text-bold">Nr Passagers : <?php echo e($NbrPassengers); ?></div>
                            </div>
                            <div class="card">
                                <div class="card-body text-bold">Total: $ <?php echo e($Total); ?></div>
                            </div>
                        </form>
                        <div class="navbar-nav align-items-center ms-auto">
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                    <i class="fa fa-solid fa-user"></i>
                                    <span class="d-none d-lg-inline-flex"><?php echo e($passenger->name); ?></span>
                                </a>
                                <div
                        ...
                        <div class="row vh-100 bg-light rounded  justify-content-center mx-0">
                            <div class="col-md-12 mb-12">
                                            ...
                                            <?php $__currentLoopData = $allPassengers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center justify-content-center gap-3">
                                                        <form action="<?php echo e(route('supprimer', $person->passenger_id)); ?>"
                                                            method="post">
                                                            <?php echo csrf_field(); ?>
                                                        ...
                                                        <a class="btn btn-primary"
                                                            href="<?php echo e(route('profile.show', $person->passenger_id)); ?>">
                                ...
                                <div class="d-flex align-items-right">
                                    <a href="<?php echo e(asset('profiles')); ?>">Afficher Plus...</a>
                                </div>
                            ...
                            <div class="col-md-12 pt-8">
                                        ...
                                        <?php $__currentLoopData = $allFlights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td class="d-flex align-items-center justify-content-center gap-3">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            href="<?php echo e(route('flight.detail', $flight->airline_id)); ?>">
                                                            <i class="fa fa-solid fa-angle-right"></i>                                                        </a>
                                                        <form action="<?php echo e(route('admin.edit', $flight->airline_id)); ?>"
                                                            method="get">
                                                            <?php echo csrf_field(); ?>
                                                        ...
                                                        <form
                                                            action="<?php echo e(route('supprimer.flight', $flight->airline_id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('DELETE'); ?>
                                                            <button class="btn btn-danger">
                                ...
                                <div class="text-align-right">
                                    <a href="<?php echo e(route('show.flight')); ?>">Afficher Plus...</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\Projects\booking\resources\views/admin/dashbord/index.blade.php ENDPATH**/ ?>