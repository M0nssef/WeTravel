    ...
    <div class="container py-4 text-center">
        <div class="row">
            <div class="col-12 p-5">
                <img src="<?php echo e(asset('storage/' . $airline->Image)); ?>" width="70%" alt="">
            </div>
            <div class="row m-0 bg-light">
                ...
                <div class="col-md-4 col-6 ps-30 my-4">
                    ...
                    <p class="h5 m-0">$<?php echo e($airline->price); ?></p>
                </div>
                <div class="col-md-4 col-6 ps-30 my-4">
...
<?php /**PATH C:\Projects\booking\resources\views/admin/detail_flight.blade.php ENDPATH**/ ?>